...
y_0=load('xend_1.mat');
y_0=y_0.xend;
k_pre=readtable('D_pre10year3.csv');%pre3
k_pre=table2array(k_pre(:,2));%第一列是正常预测，第二列是加长预测的截断%47.截断多是可以画出漂亮图像的
k_pre=k_pre(1:1860);
days = 1:7:1860*7;%1860
...
data_week=day_2_week(vaccase,364);
evdata_week=day_2_week(ev_12,364);
CVdata=day_2_week(cox_12,364);
...
xlabel('Week')
ylabel('NEV71 cases ')
% save('Scenario3vacbeta2.mat','h4')
% save('Scenario3evbeta2.mat','h2')
% save('Scenario3cvbeta2.mat','h3')
...
% figure(1)
% plot(date1,h4(1:360),'-','LineWidth',2,'Color',[0.29,0.61,0.75])
% hold on
% plot(date1,data_week(1:360),'.','MarkerSize',22,'Color',[0.97,0.53,0.47])
% ylabel('Vaccination number')
% xlabel('Year')
% legend('Fitting curve','Data')
% xtickformat('yyyy')
% figure(2)
% plot(date1,h2(1:360),'-','LineWidth',2,'Color',[0.29,0.61,0.75])
% hold on
...
% xtickformat('yyyy')
% figure(3)
% plot(date1,h3(1:360),'-','LineWidth',2,'Color',[0.29,0.61,0.75])
% hold on
% plot(date1,CVdata(1:360),'.','MarkerSize',22,'Color',[0.97,0.53,0.47])
% ylabel('Vaccination number')
% xlabel('Year')
% legend('Fitting curve','Data')
% xtickformat('yyyy')
% % save('Scenario3vac.mat','h4')